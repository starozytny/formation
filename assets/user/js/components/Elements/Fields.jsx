...
export function Input (props) {
	const { type="text", identifiant, valeur, errors, onChange, children, placeholder="", autocomplete="on", disabled=false } = props;
	...
	return <>
		<label htmlFor={identifiant} className="block mb-1 text-sm font-medium leading-6 text-gray-900">
			{children}
		</label>
